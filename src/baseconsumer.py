...
class BaseConsumer(object):
    ...
    def on_connection_open(self, _unused_connection):
        ...
        :param pika.adapters.asyncio_connection.AsyncioConnection
    ...
    def on_channel_open(self, channel):
        ...
        self.setup_exchange(self.self._exchange)
    ...
    def setup_exchange(self, exchange_name):
        ...
        self._channel.exchange_declare(
            ...
            exchange_type=self.self._exchange_type,
            callback=cb)
    ...
    def on_exchange_declareok(self, _unused_frame, userdata):
        ...
        self.setup_queue(self.self._queue)
    ...
    def on_queue_declareok(self, _unused_frame, userdata):
        ...
        """
        queue_name = userdata
        LOGGER.info('Binding %s to %s with %s', self.self._exchange,
                    queue_name, self.self._routing_key)
        cb = functools.partial(self.on_bindok, userdata=queue_name)
        self._channel.queue_bind(
            queue_name,
            self.self._exchange,
            routing_key=self.self._routing_key,
            callback=cb)
    ...
    def start_consuming(self):
        ...
        self._consumer_tag = self._channel.basic_consume(
            self.self._queue, self.on_message)
    ...
    def run(self):
        ...
        starting the IOLoop to block and allow the AsyncioConnection to
        operate.
        """
